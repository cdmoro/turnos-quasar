<template>
  ...
  >
    <q-toolbar slot="header" color="pink">
      <!-- <q-btn
        flat
    ...
    <q-tabs slot="navigation" color="pink">
      <q-tab default slot="title" icon="color_lens" name="tab-1" label="Maquillaje" />
      <q-tab slot="title" icon="content_cut" name="tab-2" label="Peluquería" />
      <q-tab slot="title" icon="pan_tool" name="tab-3" label="Manos" />
      <q-tab slot="title" icon="airline_seat_legroom_extra" name="tab-4" label="Pies" />
